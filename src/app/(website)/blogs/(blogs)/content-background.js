        ...
        <div className="fixed inset-0 w-full h-screen overflow-hidden pointer-events-none left-1/5">
            <svg width="4096" height="2031" viewBox="0 0 4096 2031" className="bottom-0 w-full text-primary opacity-40" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_103_10)">
                    ...
                    <g style={{ "mixBlendMode":"hard-light" }} filter="url(#filter0_f_103_10)">
                        <rect x="1236" y="614" width="1625" height="802.185" fill="#D3E4FF"/>
                        <rect x="1236" y="614" width="1625" height="802.185" fill="url(#paint0_linear_103_10)" fillOpacity="0.85"/>
                        <rect x="1236" y="614" width="1625" height="802.185" fill="url(#paint1_linear_103_10)" fillOpacity="0.91"/>
                        <rect x="1236" y="614" width="1625" height="802.185" fill="url(#paint2_linear_103_10)" style={{ "mixBlendMode":"darken" }}/>
                        <rect x="1236" y="614" width="1625" height="802.185" fill="url(#paint3_linear_103_10)" fillOpacity="0.8"/>
                    </g>
                </g>
                <defs>
                    <filter id="filter0_f_103_10" x="802.091" y="180.091" width="2492.82" height="1670" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
