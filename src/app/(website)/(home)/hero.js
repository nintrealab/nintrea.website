...
export const Hero = () => {
    return (
        <div className='w-full h-[35rem]'>
            <GridBackground/>
            <div className="absolute pointer-events-none inset-0 bg-grid-slate-900/[0.04] bg-[bottom_1px_center] dark:bg-grid-slate-400/[0.05] dark:bg-bottom dark:border-b dark:border-slate-100/5" style={{
